...
void
FileDirentImpl::GetPath(v8::Local<v8::String> name,
...
void
FileDirentImpl::GetName(v8::Local<v8::String> name,
                        const v8::PropertyCallbackInfo<v8::Value> &info) {
    auto ptr = GetPointer(info.This());
    auto isolate = info.GetIsolate();
    if (ptr != nullptr) {
...
FileDirentImpl::FileDirentImpl(FileDirent *dirent) : dirent_(dirent) {}

void FileDirentImpl::IsBlockDevice(const v8::FunctionCallbackInfo<v8::Value> &args) {
    auto ptr = GetPointer(args.This());
    bool ret = false;
    if (ptr != nullptr) {
        ret = fs_dirent_is_block_device(ptr->dirent_);
    }
...
void FileDirentImpl::IsCharacterDevice(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    bool ret = false;
    if (ptr != nullptr) {
        ret = fs_dirent_is_character_device(ptr->dirent_);
    }
    args.GetReturnValue().Set(ret);
}
...
void FileDirentImpl::IsDirectory(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    bool ret = false;
    if (ptr != nullptr) {
        ret = fs_dirent_is_directory(ptr->dirent_);
    }
    args.GetReturnValue().Set(ret);
}
...
void FileDirentImpl::IsFIFO(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    bool ret = false;
    if (ptr != nullptr) {
        ret = fs_dirent_is_fifo(ptr->dirent_);
    }
    args.GetReturnValue().Set(ret);
}
...
void FileDirentImpl::IsFile(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    bool ret = false;
    if (ptr != nullptr) {
        ret = fs_dirent_is_file(ptr->dirent_);
    }
    args.GetReturnValue().Set(ret);
}
...
void FileDirentImpl::IsSocket(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    bool ret = false;
    if (ptr != nullptr) {
        ret = fs_dirent_is_socket(ptr->dirent_);
    }
    args.GetReturnValue().Set(ret);
}
...
void FileDirentImpl::IsSymbolicLink(const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    bool ret = false;
    if (ptr != nullptr) {
        ret = fs_dirent_is_symbolic_link(ptr->dirent_);
    }
    args.GetReturnValue().Set(ret);
}
